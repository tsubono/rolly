                    ...
                    <div class="pri">
                        ...
                        <div class="accordion">
                            ...
                            <div class="answer cf"> <img src="../img/qa/answer_04.png">
                                <p>無料会員登録はメールアドレスのみ、有料会員登録はメールアドレス、クレジットカード情報、お届け先ご住所、電話番号、お客様の本人確認書類などが必要です。</p>
                            </div>
                            <div class="question cf"> <img src="../img/qa/question_05.png">
                                <p>有料会員登録の流れは？</p>
                            </div>
                            <div class="answer cf"> <img src="../img/qa/answer_05.png">
                                <p>有料会員登録の流れは以下のとおりです。<br>
                                    ①レンタルしたい腕時計を選択する。<br>
                                    （選択した腕時計に対応した月額料金が自動的に適用されます）<br>
                                    ↓<br>
                                    ②有料会員登録画面で必要事項（氏名、住所、連絡先電話番号、クレジットカード情報等）を入力し、所定の本人確認書類及び手首回りの登録または手首写真画像をアップロードする。<br>
                                    ↓<br>
                            ...
                            <div class="answer cf"> <img src="../img/qa/answer_06.png">
                                <p>以下のいずれかの書類が必要です。<br>
                                    ①運転免許証<br>
                                    ②保険証＋［携帯電話請求書、クレジットカード請求書、住民票のいずれか］（氏名、現住所、発行日（3ヶ月以内のもの）が確認できるもの）<br>
                                    ③パスポート＋［携帯電話請求書、クレジットカード請求書、住民票のいずれか］（氏名、現住所、発行日（3ヶ月以内のもの）が確認できるもの）<br>
                                    ※プランによっては保険証の利用になれません</p>
                            </div>
                            <div class="question cf"> <img src="../img/qa/question_07.png">
                                <p>利用するのに年齢制限はある？</p>
                            </div>
                            <div class="answer cf"> <img src="../img/qa/answer_07.png">
                                <p>18歳未満の方はご利用いただけません。また、未成年の方は、親権者の同意が必要になります。</p>
                            </div>
                            ...
                            <div class="answer cf"> <img src="../img/qa/answer_17.png">
                                <p>速やかに当社へご連絡いただき、同時に最寄の警察へ「紛失届」または「被害届」を提出してください。<br>
                                    なお、紛失」「盗難」などの場合、同等物の購入をお客様にご負担していただくこととなります。</p>
                            </div>
                            <div class="question cf"> <img src="../img/qa/question_18.png">
                                <p>サービスの停止方法は？</p>
                            </div>
                            <div class="answer cf"> <img src="../img/qa/answer_18.png">
                                <p>停止されたい場合は、①マイページからの「会員停止申請」、②レンタル中の商品がある場合は当該商品の返却、の両方が必要となります。なお、決済日の前日までに返却手続きが完了しないと、決済日に決済処理が行われてしまいますのでご注意ください。</p>
                            </div>
                            <div class="question cf"> <img src="../img/qa/question_19.png">
                                <p>退会するには？</p>
                            </div>
                            <div class="answer cf"> <img src="../img/qa/answer_19.png">
                                <p>手続きを行うためには、停止会員（商品のレンタルをしていない状態）になることが必要です。<br>
                                    停止会員になると、マイページより「退会」の手続きをおこなっていただけます。</p>
                            </div>
                        </div>
                    </div>
                </section>

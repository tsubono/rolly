            ...
            <div class="box form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group input_row">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" name="product[breadcrumb]">{{ old('product.breadcrumb') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group input_row">
                        <label class="control-label col-md-3">商品名</label>
                        <div class="col-md-6">
                            <textarea class="form-control" name="product[name]">{{ old('product.name') }}</textarea>
                        </div>
                    </div>
                </div>
